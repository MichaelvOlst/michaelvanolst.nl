...
<div class="form-group">
	...
	{{ Form::text('title', '', ['placeholder' => 'Enter the title', 'class' => 'form-control', 'required']) }}
</div>

<div class="form-group">
	{{ Form::label('description', 'Description') }}
	{{ Form::textarea('description', '', ['placeholder' => 'Enter the escription', 'class' => 'form-control', 'required']) }}
</div>
...
<div class="form-group">
	...
	{{ Form::text('slug', '', ['placeholder' => 'Enter the slug', 'class' => 'form-control', 'required']) }}
</div>

<div class="form-group">
	{{ Form::label('link', 'Link') }}
	{{ Form::text('link', '', ['placeholder' => 'Enter the link', 'class' => 'form-control', 'required']) }}
</div>
